...
const showRecipe = async function() {
    try {
        const response = await fetch('https://forkify-api.jonas.io/api/v2/recipes/664c8f193e7aa067e94e8906');
        ...
        recipe = {
            ...
            cookingTime: recipe.coking_time,
...
showRecipe(); // fetch('https://forkify-api.jonas.io/api/v2/recipes/:id');
